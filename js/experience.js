...
const CARDS = [
  { line1: 'Lishui University', line2: 'Bachelor - English', period: '2021', photo: 'assets/images/experience-1-lishui.webp', detail: "Four years at Lishui, and I stayed near the top of my cohort the whole way through — less about chasing rank, more about a habit of following through once I'd started something. That same habit carried into a few competitions along the way, the CATTI Cup translation prize being the one that stayed with me most. But what actually filled those years wasn't the grades or the titles — it was leading a student association, building a project from the ground up, and staying open to whatever came next." },
  { line1: 'President · Psychological Health Association', line2: '', period: '2023', photo: 'assets/images/experience-2-psych-association.webp', detail: 'As president, I ran the day-to-day operations of the association and organized close to 30 campus mental health events during my term — everything from planning the theme and format to coordinating the team through promotion, logistics, and the post-event review. It taught me how to break a big goal into pieces, keep a team moving in sync, and actually follow through when things got messy along the way.' },
  { line1: 'Project Lead · "New Sprout" Entrepreneurship Project', line2: '', period: '2023', photo: 'assets/images/experience-3-new-sprout.webp', detail: "As project lead, I took a small research idea — how Lishui's local culture could travel beyond its region — and turned it into a real project. We visited different parts of Lishui, interviewed over 100 people, and surveyed more than 500 more, then adapted what we found into multilingual content for WeChat, TikTok, and Instagram. It was the first time I saw a project go from a rough question to something people outside our city actually saw and responded to." },
  { line1: 'IELTS Teacher · Aiyoumi International Education', line2: '', period: '2025', photo: 'assets/images/experience-4-ielts.webp', detail: 'I designed and taught IELTS courses for adult learners, starting from where each student actually was — their level, their target score, their specific weak points — rather than a one-size-fits-all syllabus. Over the course of the role, I graded more than 100 pieces of academic writing, and slowly built a rhythm to it: spot the pattern in someone\'s mistakes, design material around it, have them practice, then adjust again. It was less about teaching a fixed curriculum and more about constantly recalibrating to what each student actually needed.' },
  { line1: 'University of Edinburgh', line2: 'Master · TESOL', period: '2025', photo: 'assets/images/experience-5-edinburgh.webp', detail: "Coming here meant entering an academic environment almost entirely unfamiliar to me — a different country, a different pace, a classroom culture built on different assumptions than the ones I grew up with. Being immersed in how people here approach argument, structure, and reasoning gradually reshaped how I think as well. That shift is largely what led me toward AI. I began by studying its fundamentals in practice — how an agent is structured, how a skill is built and integrated into one, and what distinguishes AI software people actually adopt from software that merely demonstrates well. From there, my interest shifted toward the product side: drafting my first PRDs, and learning to think less like someone experimenting with a technology and more like someone responsible for shaping what it becomes." },
];
